 ...
 *  @brief  Minimal Mongoose API stub — satisfies compiler when real library is absent.
 *
 *  Provides type declarations matching Mongoose 7.x so cpcu_ws.c compiles
 *  without network access. The resulting binary is non-functional (prints
 *  a message directing the user to run fetch.sh).
 */
